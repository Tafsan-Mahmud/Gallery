...
const ImageSearch = ({ searchText }) => {
  ...
  return (
    <div className='max-w-sm p-4 rounded overflow-hidden my-10 mx-auto'>
      <form onSubmit={onSubmit} className="w-full  max-w-sm"> 
        ...
        <button className="flex-shrink-0 colour-btn text-sm border-4 text-white py-1 px-2 rounded" type="submit">
      Search
      </button>
      </div>
      </form>
